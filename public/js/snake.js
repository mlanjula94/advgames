...
up.src = "../audio/down.mp3";
right.src = "../audio/left.mp3";
...
$.get("/api/user_data").then(function (user) {
    $.get("/api/scores/high/Snakes/" + user.id, function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var html = '<tr class="tr">' +
                ...
                '<td>' + data[i].score + '</td>' +
                '</tr>';
            $("#sn_highscore_tbody").append(html);
        }
    })
})
...
$.get("/api/user_data").then(function (user) {
    $.get("/api/scores/Snakes/" + user.id, function (data) {
        console.log(data.length);
